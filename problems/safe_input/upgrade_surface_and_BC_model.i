...
[GlobalParams]
  ...
  cd = 8e-9          # DOPANT GRADIENT ENERGY COEFFICIENT [J/mol.m]
  cv = 1e-9          # VACANCY GRADIENT ENERGY COEFFICIENT [J/mol.m]
  F = 96485          # ENERGY CONSTANT

  eta1 = 0.0           # Pre-EXPONTENTIAL FACTOR: zeta_ads
  eta2 = 0.0           # Pre-EXPONTENTIAL FACTOR: zeta_inc
