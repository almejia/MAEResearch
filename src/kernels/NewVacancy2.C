...
#include "NewVacancy2.h"

registerMooseObject("MooseApp", NewVacancy2);

template <>
InputParameters
validParams<NewVacancy2>()
{
...
NewVacancy2::NewVacancy2(const InputParameters & parameters)
  : Kernel(parameters),
...
Real
NewVacancy2::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (jvar == _e_var)
  {
